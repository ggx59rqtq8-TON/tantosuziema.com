...
const SHOPIFY_STORE_PERMANENT_DOMAIN = 'tantosuziema-growth-hub-vj7ju.myshopify.com';
const SHOPIFY_STOREFRONT_URL = `https://${SHOPIFY_STORE_PERMANENT_DOMAIN}/api/${SHOPIFY_API_VERSION}/graphql.json`;
const SHOPIFY_STOREFRONT_TOKEN = '7724076b8f38e3df5cf0ee2636a69933';
