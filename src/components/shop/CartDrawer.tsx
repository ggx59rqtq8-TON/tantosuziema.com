  ...
  return (
    <Sheet open={isOpen} onOpenChange={setIsOpen}>
      <SheetTrigger asChild>
        <Button variant="navy" size="icon" className="relative text-gold">
          ...
          {items.length === 0 ? (
            ...
            <>
              ...
              <div className="flex-shrink-0 space-y-4 pt-4 border-t">
                ...
                <Button onClick={handleCheckout} className="w-full" variant="gold" size="lg" disabled={items.length === 0 || isLoading || isSyncing}>
